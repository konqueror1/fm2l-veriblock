 ...
 * Remember that pthread.h (this file) is used for both the DLL and application
 * builds.
 */
...
PTW32_DLLPORT int PTW32_CDECL pthread_attr_getschedparam(
    const pthread_attr_t *attr, struct sched_param *param);

PTW32_DLLPORT int PTW32_CDECL pthread_attr_setschedparam(
...
PTW32_DLLPORT int PTW32_CDECL pthread_once(
    pthread_once_t *once_control, void(PTW32_CDECL *init_routine)(void));

#if PTW32_LEVEL >= PTW32_LEVEL_MAX
PTW32_DLLPORT ptw32_cleanup_t *PTW32_CDECL ptw32_pop_cleanup(int execute);

PTW32_DLLPORT void PTW32_CDECL ptw32_push_cleanup(
    ptw32_cleanup_t *cleanup, ptw32_cleanup_callback_t routine, void *arg);
#endif /* PTW32_LEVEL >= PTW32_LEVEL_MAX */
...
PTW32_DLLPORT int PTW32_CDECL pthread_rwlock_timedrdlock(
    pthread_rwlock_t *lock, const struct timespec *abstime);

PTW32_DLLPORT int PTW32_CDECL pthread_rwlock_wrlock(pthread_rwlock_t *lock);

PTW32_DLLPORT int PTW32_CDECL pthread_rwlock_timedwrlock(
    pthread_rwlock_t *lock, const struct timespec *abstime);
...
PTW32_DLLPORT unsigned __int64 PTW32_CDECL
...
#pragma message( \
    "Specify \"/DPtW32NoCatchWarn\" compiler flag to skip this message.")
#pragma message( \
    "------------------------------------------------------------------")
#pragma message( \
    "When compiling applications with MSVC++ and C++ exception handling:")
#pragma message( \
    "  Replace any 'catch( ... )' in routines called from POSIX threads")
